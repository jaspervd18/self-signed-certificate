...
openssl pkcs12 -export -out $SSL_FOLDER/mydomain.pfx -inkey $SSL_FOLDER/mydomain.key -in $SSL_FOLDER/mydomain.crt -certfile $SSL_FOLDER/rootCA.crt -passin pass:password -passout pass:password
